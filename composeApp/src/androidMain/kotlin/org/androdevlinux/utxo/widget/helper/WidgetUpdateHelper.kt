...
object WidgetUpdateHelper {
    ...
    fun updateWidget(
        ...
        updateScope.launch {
            try {
                ...
                val refreshIntent =
                    android.content.Intent(context, FavoritesWidgetProvider::class.java).apply {
            ...
            if (favorites.isEmpty()) {
                ...
                favorites.forEachIndexed { index, symbol ->
                    if (index < MAX_FAVORITES) {
                        ...
                        // Unique request code for each item
                        val coinDetailPendingIntent =
                            android.app.PendingIntent.getActivity(
                                context,
                                index + 100,
                                coinDetailIntent,
                        ...
                        if (tickerData != null) {
                            ...
                            if (klines.isNotEmpty()) {
                                val chartBitmap =
                                    ChartHelper.createSparklineBitmap(
                                        klines = klines,
                                        width = 80,
                                        height = 40,
    ...
    private fun extractSymbolParts(
        symbol: String,
