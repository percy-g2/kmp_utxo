...
Execute the [push-code](.cursor/skills/push-code/SKILL.md) skill:
...
Execute the [create-pr](.cursor/skills/create-pr/SKILL.md) skill:
...
Execute the [review-pr](.cursor/skills/review-pr/SKILL.md) skill on the PR created in step 2:
- Analyze the diff
- Post review comment
